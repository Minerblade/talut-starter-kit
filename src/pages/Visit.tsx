          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card className="p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>✓ Arrive a few minutes early for parking and wudu</li>
                <li>✓ Wudu facilities available inside</li>
                <li>✓ Prayer spaces for men and women</li>
                <li>✓ Feel free to ask anyone for help</li>
              </ul>
            </Card>
            ...
            <Card className="p-6">
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li>✓ Welcoming, family-friendly environment</li>
                <li>✓ Five daily prayers and Jumu'ah on Fridays</li>
                <li>✓ Regular classes and community programs</li>
                <li>✓ Modest dress appreciated</li>
              </ul>
            </Card>
          </div>
        </div>
